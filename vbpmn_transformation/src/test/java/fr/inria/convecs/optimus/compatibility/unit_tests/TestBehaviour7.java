...
public class TestBehaviour7 extends GenericTest
{
	...
	private static final String FILE_1 = "loop_choice_A_B_C.pif";
	private static final String FILE_2 = "loop_choice_A_B_C.bcg";
