...
public class Test29 extends GenericTest
{
	...
	private static final String PIF_FILE_1 = "Process_8T.pif";			//File 1: Balanced inclusive gateway inside a loop => should work
	private static final String PIF_FILE_2 = "Process_8T.pif";			//File 2: Balanced inclusive gateway inside a loop => should work
