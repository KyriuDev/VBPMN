...
public class TestBehaviour3 extends GenericTest
{
	...
	private static final String FILE_1 = "parallel_A_B_C.pif";
	private static final String FILE_2 = "parallel_A_B_C.bcg";
