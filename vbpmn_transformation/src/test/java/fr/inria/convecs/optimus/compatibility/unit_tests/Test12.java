...
public class Test12 extends GenericTest
{
	...
	private static final String PIF_FILE_1 = "Process_6a.pif";			//File 1
	private static final String PIF_FILE_2 = "Process_6a.pif";			//File 2
