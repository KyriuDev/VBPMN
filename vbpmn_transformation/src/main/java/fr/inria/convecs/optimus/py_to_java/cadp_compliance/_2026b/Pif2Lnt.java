package fr.inria.convecs.optimus.py_to_java.cadp_compliance._2026b;
...
public class Pif2Lnt extends Pif2LntGeneric
{
	...
	class Process
	{
		...
		void genLNT()
		{
			...
			for (Node n : this.finals)
			{
				...
				if (ADD_LTL_DUMMY_LABELS)
				{
					...
					nbCharCurrentLine = dummyNodeWithIdentifier.length() + 12 + indentBase;
		...
		void genSVL()
		{
			...
			final ArrayList<String> alpha = this.alpha();
			dumpAlphabet(alpha, svlCommandBuilder, false, false);
