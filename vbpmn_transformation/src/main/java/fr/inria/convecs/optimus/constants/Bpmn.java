...
public class Bpmn
{
    ...
    public static final String FIND_INCOMING_FLOWS_GATEWAYS_LNT_FUNCTION = "find_incf_gateways";
    ...
    public static final String INACTIVE_INCOMING_FLOW_VARIABLE = "inactiveincf";
